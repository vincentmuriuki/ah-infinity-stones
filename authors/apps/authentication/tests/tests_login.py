...
class UserTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.test_user = {'email': 'remmy@test.com', 'password': 'Password123'}
    ...
    def test_login_user(self):
        ...
        response = self.client.post(
            'api/users/login', data=json.dumps(self.test_user), format='json')
    ...
    def test_cannot_login_unregistered_user(self):
        ...
        self.assertEqual(
            json.loads(response.data)["message"], "User does not exist.")
